...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:'+options.clusterID+'_SS_AToGG_HLT_M'+str(int(options.mass))+'.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:'+options.clusterID+'_AToGG_RECO_M'+str(options.mass)+'.root'),
