...
class Photon_RefinedRecHit_NTuplizer : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   ...
   private:
      ...
      std::vector<float> dRHit_Eta[4];
      std::vector<float> dRHit_Phi[4];
      std::vector<float> dRHit_X[4];
      std::vector<float> dRHit_Y[4];
      std::vector<float> dRHit_Z[4];
      ...
      std::vector<float> dRRecHitFrac[4];
      std::vector<float> dRRecHitEn[4];
      ...
      std::vector<float> A_lead_Gen_mass;
      std::vector<float> A_lead_Gen_pt;
      std::vector<float> A_lead_Gen_eta;
      std::vector<float> A_lead_Gen_phi;

      std::vector<float> A_sublead_Gen_mass;
      std::vector<float> A_sublead_Gen_pt;
      std::vector<float> A_sublead_Gen_eta;
      std::vector<float> A_sublead_Gen_phi;

      //std::vector<float> Pho_Gen_Eta;
      //std::vector<float> Pho_Gen_Phi;
      //std::vector<float> Pho_Gen_E;
      std::vector<float>  A_lead_Pho_Gen_Pt;
      std::vector<float>  A_lead_Pho_Gen_Eta;
      std::vector<float>  A_lead_Pho_Gen_Phi;
      std::vector<float>  A_lead_Pho_Gen_E;
      std::vector<float>  A_sublead_Pho_Gen_Pt;
      std::vector<float>  A_sublead_Pho_Gen_Eta;
      std::vector<float>  A_sublead_Pho_Gen_Phi;
      std::vector<float>  A_sublead_Pho_Gen_E;
 


      std::vector<float> H_Gen_mass;
      std::vector<float> H_Gen_pt;
      std::vector<float> H_Gen_eta;
      std::vector<float> H_Gen_phi;
