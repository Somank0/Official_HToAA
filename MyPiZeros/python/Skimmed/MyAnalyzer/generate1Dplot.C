...
gStyle->SetOptStat(1); gStyle->SetStatX(0.95);}
gPad->Modified();
gPad->Update(); */
...
void generate1Dplot()
{
  ...
  int n_files=1;
    ...
    //f[0] = new TFile("MA_0p6_plot.root");
    f[0] = new TFile("MA_1GeV_plot.root");
    
    vector<string> filetag=  {"M_a = 1GeV"};
    //vector<string> filetag=  {"M_a = 0.6 GeV"};
...
{"A1_mass","Mass (GeV)",10,0,20,0,3,"a_{1} mass"},
{"A1_pT","pT (GeV)",10,0,20,0,400,"pT of a_{1}"},
{"A1_eta","#eta",10,0,20,-8,8,"#eta of a_{1}"},
{"A1_phi","#phi",10,0,20,-4,4,"#phi of a_{1}"},
{"A1_E","Energy (GeV)", 10,0,20,0,2000,"Energy of a_{1}"},
{"A1_LB","Lorentz boost (#gamma)",10,0,20,0,2000,"Lorentz boost of a_{1}"},
{"A2_mass","Mass (GeV)",10,0,20,0,3,"a_{2} mass"},
{"A2_pT","pT (GeV)",10,0,20,0,400,"pT of a_{2}"},
{"A2_eta","#eta",10,0,20,-8,8,"#eta of a_{2}"},
{"A2_phi","#phi",10,0,20,-4,4,"#phi of a_{2}"},
{"A2_E","Energy (GeV)", 10,0,20,0,2000,"Energy of a_2}"},
{"A2_LB","Lorentz boost (#gamma)",10,0,20,0,2000,"Lorentz boost of a_{2}"},
{"Angle_bw_As","Angle betwen a s (in radians)",10,0,20,0,4,"Angle between a s"},
...
{"AA_angle_EBEB","Angle between a s (in radians)",10,0,20,0,4,"Both a s in ECAL barrel"},
{"AA_angle_EBEE","Angle between a s (in radians)",10,0,20,0,4,"One a in EB and one in EE"},
{"AA_angle_EEEE","Angle between a s (in radians)",10,0,20,0,4,"Both a s in ECAL endcaps"},
{"E_ratio_A2_A1","Energy ratio (E_{a_{2}}/E_{a_{1}})",10,0,20,0,20,"Energy ratio"},
{"Pho1_A1_pt","pT (GeV)",10,0,20,0,400,"Pho1_{a_{1}} pT"},
{"Pho1_A1_eta","#eta",10,0,20,-8,8,"Pho1_{a_{1}} #eta"},
{"Pho1_A1_phi","#phi",10,0,20,-4,4,"Pho1_{a_{1}} #phi"},
{"Pho1_A1_E","Energy (GeV)",10,0,20,0,2000,"Pho1_{a_{1}} energy"},
{"Pho2_A1_pt","pT (GeV)",10,0,20,0,400,"Pho2_{a_{1}} pT"},
{"Pho2_A1_eta","#eta",10,0,20,-8,8,"Pho2_{a_{1}} #eta"},
{"Pho2_A1_phi","#phi",10,0,20,-4,4,"Pho2_{a_{1}} #phi"},
{"Pho2_A1_E","Energy (GeV)",10,0,20,0,2000,"Pho2_{a_{1}} energy"},
{"Pho1_A2_pt","pT (GeV)",10,0,20,0,400,"Pho1_{a_{2}} pT"},
{"Pho1_A2_eta","#eta",10,0,20,-8,8,"Pho1_{a_{2}} #eta"},
{"Pho1_A2_phi","#phi",10,0,20,-4,4,"Pho1_{a_{2}} #phi"},
{"Pho1_A2_E","Energy (GeV)",10,0,20,0,2000,"Pho1_{a_{2}} energy"},
{"Pho2_A2_pt","pT (GeV)",10,0,20,0,400,"Pho2_{a_{2}} pT"},
{"Pho2_A2_eta","#eta",10,0,20,-8,8,"Pho2_{a_{2}} #eta"},
{"Pho2_A2_phi","#phi",10,0,20,-4,4,"Pho2_{a_{2}} #phi"},
{"Pho2_A2_E","Energy (GeV)",10,0,20,0,2000,"Pho2_{a_{2}} energy"},
{"A1_pho1_by_pho2_pt","pT ratio (pT_{pho2}/pT_{pho1}",10,0,20,0,20,"a_{1} photon pT ratio"},
{"A1_pho1_by_pho2_E","E ratio (E_{pho2}/E_{pho1})",10,0,20,0,20,"a_{1} photon energy ratio"},
{"A1_pho1_pho2_angle","Angle between photons (#theta)",10,0,20,0,4,"Opening angle of photons (a_{1})"},
{"A2_pho1_by_pho2_pt","pT ratio (pT_{pho2}/pT_{pho1}",10,0,20,0,20,"a_{2} photon pT ratio"},
{"A2_pho1_by_pho2_E","E ratio (E_{pho2}/E_{pho1})",10,0,20,0,20,"a_{2} photon energy ratio"},
{"A2_pho1_pho2_angle","Angle between photons (#theta)",10,0,20,0,4,"Opening angle of photons (a_{2})"},
{"A_EB_pho_angle","Angle between photons (#theta)",10,0,20,0,4,"a s in ECAL barrel" },
{"A_EE_pho_angle","Angle between photons (#theta)",10,0,20,0,4,"a s in ECAL endcaps"},
...
vector<string> with_stat ={"AA_angle_EBEE","AA_angle_EEEE","AA_angle_EBEB"};
  ...
  for(int i_file=0; i_file<n_files;i_file++)
      ...
      for(int i_cut=0; i_cut<size(varName);i_cut++)
	{
	  ...
	  TH1F* h_resp1 = (TH1F*)f[i_file]->Get(hist_name); // SR
	  TH1F* h_resp2=(TH1F*)h_resp1->Clone();
	  h_resp2->SetName("");
